...
SELECT pokedex_num, pokemon_name, region_name, type_name, evolves, sub_type_name, hp, attack, defence, special_atk, special_def, speed, height_m, weight_kg, ability, ability_effect, sub_ability, sub_ability_effect, hidden_ability, hidden_ability_effect
